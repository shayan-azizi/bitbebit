...
class UserDataValidation:
    ...
    def username_validation(self,context:dict, username : str) -> dict:
    ...
    def password_validation(self,context:dict, p1:str, p2:str) -> dict:
    ...
    def name_validation(self,context:dict, fname, lname)->dict:
